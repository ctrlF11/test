...
<div id="inq_articles">
	...
	<form name="f" method="post" action="admin_gongji_writeOk.do" onsubmit="return write_check(this);">
	<div id="gongji_topbar">
			...
			<ul>
				<li style="width: 70%; float: left;">
					<input type="text" name="gongji_title" size="30">
				</li>
			</ul>
		</div>
		<div id="gongji_board" style="height: 700px;">
			<ul style="border: none;">
				...
				height: 500px; text-align: left; padding: 10px; border: none;">
					<textarea rows="32" cols="80" name="gongji_cont"></textarea>
				</li>
			</ul>
		</div>
