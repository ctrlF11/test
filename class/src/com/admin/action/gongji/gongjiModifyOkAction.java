...
public class gongjiModifyOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int gongji_no = Integer.parseInt((String)request.getParameter("gongji_no"));
		
		adminDAO dao = new adminDAO();
		
		int check = dao.updateGongji(gongji_title, gongji_cont, gongji_no);
