...
<div id="inq_articles">
	...
	<div id="inquire_board">
		...
		%>
			<ul>
				<li style="width: 15%;"><%=inquire.getInquire_no() %></li>
				<li style="width: 30%;"><a href="admin_inquire_cont.do?no=<%=inquire.getInquire_no() %>" onfocus="this.blur()"><%=inquire.getInquire_title() %></a></li>	
				<li style="width: 20%"> <%= inquire.getInquire_id() %> </li>		
