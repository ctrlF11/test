...
<div id="inq_articles">
	...
	<div id="gongji_bottom">
		<ul style="height: 15px;">
			<li>
				<input type="button" onclick="javascript:document.location.href='gongji_list.do?page=<%= backPage %>'" value="목록"
		...
		<ul style="text-align: left; margin-left: -20px;">
			...
			%>
			<li>
				△<a href="<c:url value='/gongji_cont.do' />?no=<%= vop.getGongji_no() %>&amp;page=<%= backPage %>" ><%= vop.getGongji_title() %></a>
			</li>
			<%} %>
			<%
			...
			%>
			<li>
				▽<a href="<c:url value='/gongji_cont.do' />?no=<%= vom.getGongji_no() %>&amp;page=<%= backPage %>" ><%= vom.getGongji_title() %></a>
			</li>
			<%} %>
		</ul>
