...
<div id="inq_articles">
	...
	<div id="gongji_board">
		<ul>
			<li style="width: 50%"><%= vo.getInquire_title() %></li>
			<li style="width: 25%"><%= vo.getInquire_regdate() %></li>
			<li style="width: 20%"><%= vo.getInquire_question() %></li>
		</ul>
		<ul>
	...
	<div id="gongji_bottom">
		...
		<ul style="text-align: left; margin-left: -20px;">
			...
			%>
			<li>
				△<a href="<c:url value='/inquire_cont.do' />?no=<%= vop.getInquire_no() %>" ><%= vop.getInquire_title() %></a>
			</li>
			<%} %>
			<%
			...
			%>
			<li>
				▽<a href="<c:url value='/inquire_cont.do' />?no=<%= vom.getInquire_no() %>" ><%= vom.getInquire_title() %></a>
			</li>
			<%} %>
		</ul>
